...
// TOKEN_ENCRYPTION_KEY is a 32-byte key, base64-encoded, set via
// `supabase secrets set TOKEN_ENCRYPTION_KEY=...` (see README for how to
// generate one). Never store a provider token in plaintext.
//
